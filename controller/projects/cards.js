export class CriadorCards {
    ...
    async criarCards() {
        const response = await fetch('https://backendportfolio-fawn.vercel.app/pegaCards');
    ...
    async addCard() {
        ...
        const response = await fetch('https://backendportfolio-fawn.vercel.app/addCard', {
            method: 'POST',
            headers: {
    ...
    async removerCard(id) {
        const response = await fetch('https://backendportfolio-fawn.vercel.app/deleteCard', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
